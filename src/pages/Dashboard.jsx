...
function Dashboard() {
  ...
  return (
    <PageWrapper expanded>
      <Typography variant="h2" color="white" marginLeft={10} marginTop={5}>
        All courses
      </Typography>
            ...
            <Grid
              ...
              <Box
                ...
                <SummaryCard
                  ...
                  value={parseFloat(session?.balance_roi_available || 0)
                    .toFixed(2)
                    .toLocaleString()}
                  trend={(
                    Number(session?.balance_roi_payed || 0) +
                    Number(session?.balance_roi_available || 0)
                  )
                    .toFixed(2)
                    .toLocaleString()}
                ...
                <SummaryCard
                  ...
                  value={parseFloat(session?.balance_binary_available || 0)
                    .toFixed(2)
                    .toLocaleString()}
                  trend={(
                    Number(session?.balance_binary_payed || 0) +
                    Number(session?.balance_binary_available || 0)
                  )
                    .toFixed(2)
                    .toLocaleString()}
                ...
                <SummaryCard
                  ...
                  value={parseFloat(session?.balance_direct_available || 0)
                    .toFixed(2)
                    .toLocaleString()}
                  trend={(
                    Number(session?.balance_direct_payed || 0) +
                    Number(session?.balance_direct_available || 0)
                  )
                    .toFixed(2)
                    .toLocaleString()}
              ...
              <Box
                ...
                <Box
                  ...
                  <Typography color="white" padding={2}>
                    {memberIB
                      ? "Próximo pago membresía IB"
                      : "Comienza tu red con Membresía IB "}
                  </Typography>
