...
export default function Signup() {
  ...
  const [user, setUser] = useState({ fullName: "", email: "", cellphone: "", password: "", confirmPassword: "", slug: params.slug });
  ...
  const handleSubmit = async (event) => {
    ...
    if (!(user.fullName && user.email && user.cellphone && user.password && user.confirmPassword)) {
      setAlert({
        show: true,
        ...
        >
          ...
          <Grid display="flex" flexDirection="column" gap={2}>
            ...
            <Typography textAlign="center">
              Crea una nueva cuenta completando el formulario de registro con tu información personal.
            </Typography>
          </Grid>
          <Box component="form" width="100%" onSubmit={handleSubmit} noValidate>
            <Grid display="flex" flexDirection="column" gap={2}>
              <Grid display="flex" flexDirection="column" gap={1}>
                <InputLabel>
                  Nombre completo <span style={{ color: theme.palette.custom.required }}>*</span>
                </InputLabel>
                <TextField
                  name="fullName"
              ...
              <Grid display="flex" flexDirection="column" gap={1}>
                <InputLabel>
                  Celular <span style={{ color: theme.palette.custom.required }}>*</span>
                </InputLabel>
                <TextField
                  name="cellphone"
                  type="cellphone"
              ...
              {user.slug && (
                <Grid display="flex" flexDirection="column" gap={1}>
                  <InputLabel>Slug de invitación</InputLabel>
                  <TextField
                    name="slug"
                    fullWidth
                ...
                <FormControlLabel
                  ...
                  label={
                    <>
                      ...
                      <Link to="/termsAndConditions.pdf" component={RouterLink} target="_blank">
